                ...
                <div className='container' ref={this.container}>
                    <div className='apl-topbar--wrapper'>
                        ...
                        <div className={`apl-topbar--menu ${toggle ? 'apl-topbar--menu--show' : ''}`}>
                            {otherPage.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                <ul>
                                    <div className='apl-topbar--menu--dropdown'>
                                        <button type='button' className={`${pathnameDropdownGroup.includes(location.pathname.replace(/^\/en|\/$/g, '')) ? 'apl-topbar--menu--active' : ''}`} onClick={this.handleShow}>
                                            Solusi Kami
                                            <span />
                                        </button>
                                    ...
                                    <div className='apl-topbar--menu--dropdown'>
                                        <button type='button' className={`${pathnameDropdownProdut.includes(location.pathname.replace(/^\/en|\/$/g, '')) ? 'apl-topbar--menu--active' : ''}`} onClick={this.handleShowProduct}>
                                            Produk
                                            <span />
                                        </button>
                                    ...
                                    <li>
                                        {buttonInstallGroup.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                        ...
                                        {buttonJoinGroup.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                            <a className='apl-topbar--menu--button' href='https://play.google.com/store/apps/details?id=co.warungpintar.mitra' target='_blank' rel='nofollow noopener noreferrer'>
                                                Gabung Sekarang
                                            </a>
                                        }
                                        {buttonContactGroup.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                        ...
                                        {buttonContactEngGroup.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                            <a className='apl-topbar--menu--button' href='mailto:partnership@warungpintar.co' target='_blank' rel='nofollow noopener noreferrer'>
                                                Contact Us Now
                                            </a>
                                        }
                                        {buttonCareerGroup.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                        ...
                                        {
                                            buttonLearnNow.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                            ...
                            {juraganWarungPage.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                <ul>
                            ...
                            {juraganGrosirPage.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                <ul>
                            ...
                            {bizzyConnectPage.includes(location.pathname.replace(/^\/en|\/$/g, '')) &&
                                <ul>
