    ...
    <Layout location={location} logo={data.logoImage}>
      ...
      <section className='feature-section'>
        <Service
          ...
          subtitle='Warung Pintar Group provides solutions that suits your business at best'
        >
          <ServiceItem
            title='Warungs Owner'
      ...
      <section className='download-section'>
        <Download
          title='Install Warung Pintar Apps'
          ...
          withOther={false}
        >
          <DownloadItem title='From the Nearest Wholesalers ' imageSrc={getImage(data.downloadImages.nodes[0])} imageAlt="Belanja di Toko grosir terdekat"/>
          <DownloadItem title='From Warung Pintar Distribution' imageSrc={getImage(data.downloadImages.nodes[1])} imageAlt="Belanja di Warung Pintar Distribusi"/>
          <DownloadItem title='From Official Distributors' imageSrc={getImage(data.downloadImages.nodes[2])} imageAlt="Belanja dari distributor resmi"/>
        </Download>
      </section>

      <section className='testimonial-section'>
        <Testimonial
          title="Juragan Pintar's Testimoni"
          subtitle={null}
          isInverse={false}
          isSecondary={false}
        >
      ...
      <section className='statistic-section'>
        <Statistic
          title='Since 2017, Warung Pintar Group has grown across Indonesia '
        >
      ...
      <section className='jumbotron-section'>
        <Jumbotron
          ...
          buttonPrimaryLabel='Install Now'
